...
var Engine = (function(global) {
    ...
    var doc = global.document,
        ...
        lastTime;
    var canvas_score = doc.createElement('canvas'),
        ctx_score = canvas_score.getContext('2d');

    // 利用defineProperty同步更改score
    // 创建记分板
    // 给一个全局变量，记录人物分数
    // var score = {count:0};
    // Object.defineProperty(score, 'count', {
    //   get: function() {
    ...
    ctx.strokeText('For Fun',canvas.width/2,25);
    // canvas_score.width = 100;
    // canvas_score.height = 606;
    // ctx_score.font='30px Verdana';
    // ctx_score.textAlign = 'center';
    // ctx_score.fillStyle='blue';
    // ctx_score.fillText('Your Score' + score.count,0, 100);
    doc.body.appendChild(canvas);
    // doc.body.appendChild(canvas_score);
